...
Ceux qui ne sont pas dérangés par les notifications peuvent se renommer pour ajouter l'emoticon 🔔 `:bell:` à leur pseudo.
...
1. Ils représentent leur communauté auprès du staff : les ambassadeurs sont responsables de remonter les différentes propositions, demandes ou avis qu'ils lisent dans leurs salons.
...
- :bell: : Utilisé pour indiquer aux autres si vous voulez être mentionné quand on vous répond.
...
Le staff peut être contacté par le système de ticket via le bouton dédié ci-dessous (aussi présent dans le canal #regles ou via la commande `!newticket`. Cela vous créera un canal privé dans lequel vous pouvez converser avec le staff et les ambassadeurs.
