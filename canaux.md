...
| #c | :langage_c: | C |
| #cpp | :langage_cpp: | C++ |
| #csharp | :langage_csharp: Cliquez pour voir les liens utiles :<br><br>Cours<br>	- https://learn.microsoft.com/en-us/dotnet/csharp/ : C#<br>	- https://learn.microsoft.com/fr-fr/aspnet/core/?view=aspnetcore-2.2 : ASP.NET (Web Apps)<br>	- https://www.e-naxos.com/AllDotBlog.html : WPF, Xamarin, MVVM, Linq<br>	- https://codeblog.jonskeet.uk/category/edulinq/ : Linq<br>:pushpin: N'oubliez pas de lire les messages epinglés ! | C# |
| #html-css | | HTML/CSS |
